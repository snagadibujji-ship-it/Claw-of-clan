...
from ghia_scout.agent.builtin_tools import enforce_host_path_constraints
...
def _get_recon_cfg(agent: Any) -> Any:
    from ghia_scout.config.schema import ReconConfig
